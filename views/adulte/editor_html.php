...
<div class="row">
    ...
    <div class="row" style="padding:4px 0">
        ...
        <div class="col-md-3">
            <a href="https://galeriemuseale.inrap.fr/index.php/Expositions/Show/Details/id/<?= $expo_id ?>" target="_blank"><button class="btn btn-light" style="width:100%">Aperçu</button></a>
        </div>
        <div class="col-md-3">
            <button class="btn btn-light" style="width:100%"  id="versionsButton" onclick="$('#versions').toggle();">Afficher les anciennes versions</button>
        </div>
        <div class="col-md-3">
        ...
        <div class="col-md-12">
            ...
            <?php 
                ...
                foreach($versions as $index=>$version) {
                    ...
                    print '<a href="'.__CA_URL_ROOT__.'/index.php/expoInrap/Exposition/EditFormFromVersion/expo_id/'.$expo_id.'/version/'.$version["version"].'"><span class="badge badge-primary" style="background:blue">'.$version["version"].'</span></a>';
    ...
    <div class="row" style="padding:4px 0;position:fixed;bottom:4px;left:4px;">
        <div class="col-md-2">
        <button class="btn btn-primary saveButton" style="width:100%"  disabled="disabled" onclick="articleSave()">
            <?php if($is_version): ?>    
            Restaurer cette version
...
<script>
    const editor = new EditorJS({
        ...
        tools: {
            ...
            /*animationDiapo: {
                class: AnimationDiapo,
                inlineToolbar: true,
                config: {
                    rows: 5,
                    cols: 10,
                },
                default: [["perso","time","end","type","zoom","x","y","x2","y2","text"]]
            }*/
    ...
    function articleSave() {
        editor.save().then((output) => {
            ...
            $.ajax({
                    method: "POST",
                    url: "<?php print __CA_URL_ROOT__; ?>/index.php/expoInrap/Exposition/SaveExpoJson/id/<?= $expo_id ?>",
                    data: output,
                    dataType: "json"
                })
                .done(function(result) {
                    ...
                    if (result.result == "ok") {
                        ...
                        document.location.href="<?= __CA_URL_ROOT__ ?>/index.php/expoInrap/Exposition/EditForm/expo_id/<?= $expo_id ?>"; 
                    }
                });
        }).catch((error) => {
