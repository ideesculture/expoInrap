...
<table style="width: 100%;border:1px solid #ddd;" class="liste-expos">
    ...
    <tbody>
        ...
        foreach ($expos as $expo_id => $expo) {
            print "<tr>";
            print '<td style="border:1px solid #ddd;"><a title="Modifier" href="'.__CA_URL_ROOT__.'/index.php/expoInrap/Exposition/EditForm/expo_id/' . $expo_id . '"><i class="caIcon fa fa-file editIcon fa-2x" title="Modifier"></i></a></td>';
            ...
            print '<td style="border:1px solid #ddd;"><a title="Supprimer" href="'.__CA_URL_ROOT__.'/index.php/expoInrap/Exposition/deleteExpo/expo/id/' . $expo_id . '"><i class="caIcon fa fa-times deleteIcon fa-2x" title="Supprimer"></i></a></td>';
            print "</tr>";
        }
